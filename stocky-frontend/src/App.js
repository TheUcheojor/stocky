...
function App() {
  ...
  return (
    <Router>
      <div id="header" onClick={showMobileNavigationMenu}>
        {" "}
        Stocky{" "}
      </div>
      <VerticalNavBar />
      ...
      <Switch>
        <Route
          path="/"
          component={() => <OverviewPage email={user.email} />}
          exact
        />
        <Route path="/about" component={AboutPage} />
        <Route
          path="/settings"
          component={() => <SettingsPage email={user.email} />}
        />
        <Route
          path="/strategy-console"
          component={() => <StrategyConsolePage email={user.email} />}
        />
        <Route
          path="/stocks/:symbol"
          component={({ match }) => (
            <StockPage match={match} email={user.email} />
          )}
        />
